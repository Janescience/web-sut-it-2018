<?php
     ...
     define('TEXT_WELCOME', '<!-- Header Carousel -->
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <!-- S__7356459.jpg -->
            ...
            <div class="item active">
              <div class="fill" style="background-image:url(\'images/coversite2.jpg\');"></div>
                <div class="carousel-caption">
                    <h2>รับสมัครนักศึกษาระดับบัณฑิตศึกษา </h2>
                    ภาค 1/2560 (หลักสูตรปกติ)
            ...
            <div class="item">
                ...
                <div class="carousel-caption">
                    <h2>ครบรอบ 20 ปี สาขาวิชาเทคโนโลยีสารสนเทศ</h2>
                    ติดตามภาพบรรยากาศได้ที่นี่...<a href="https://www.facebook.com/billanuwong/media_set?set=a.419013921628910.1073741907.100005609170564&type=3"> <button type="button" class="btn btn-info">ชมภาพบรรยากาศ</button> </a>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="hovereffect thumbnail">
                            <img class="img-responsive" src="images/_MG_5050.jpg" alt="">
                            <div class="overlay">

                             <h2>หลักสูตรที่เปิดสอน <br/> ระดับปริญญาตรี</h2>
                             <a class="info" href="programs_bach.php?lang=th">รายละเอียด</a>
                            </div>
                        </div>
                        ...
                        <a href="programs_bach.php?lang=th" class="btn btn-info"> รายละเอียด </a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="hovereffect thumbnail">
                            <img class="img-responsive" src="images/master1.jpg" alt="">
                            <div class="overlay">
                             <h2>หลักสูตรที่เปิดสอน <br/> ระดับปริญญาโท</h2>
                                <!--  <a class="info" href="programs.php?lang=th">รายละเอียด</a> -->
                                <a class="info" href="programs_master_2016.php?lang=th">รายละเอียด</a> 
                            </div>
                        </div>
                        ...
                        <a href="programs_master_2016.php?lang=th" class="btn btn-info"> รายละเอียด </a>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="hovereffect thumbnail">
                            <img class="img-responsive" src="images/phd.jpg" alt="">
                            <div class="overlay">
                             <h2> หลักสูตรที่เปิดสอน <br/> ระดับปริญญาเอก </h2>
                             <a class="info" href="programs_phd_2016.php?lang=th">รายละเอียด</a>
  ...
  <ul class="media-list">
    <li class="media">
      <div class="media-left">
        <a href="#">
          <img class="media-object" src="images/pub_pic_major_tn.jpg" alt="...">
        </a>
      </div>
      <div class="media-body">
        <h4 class="media-heading">เกณฑ์การเลือกหลักสูตร IT รุ่นปี 55 1/58</h4>
        
        <span style="color: #999999;"><i class="fa fa-clock-o" aria-hidden="true"></i> 20 กันยายน 2559 </span>
        <br><a class="btn btn-info btn-xs" href="file/major_IT_2555_1_2558.pdf" role="button"> อ่านต่อ » </a>
      </div>
    </li>
  </ul>
  <ul class="media-list">
    <li class="media">
      <div class="media-left">
        <a href="#">
          <img class="c" src="images/pub_pic_major_hp_tn.jpg" alt="...">
        </a>
      </div>
      <div class="media-body">
        <h4 class="media-heading"> เกณฑ์การเลือกหลักสูตร IT(HP) 3/57 </h4>
        <span style="color: #999999;"><i class="fa fa-clock-o" aria-hidden="true"></i> 20 กันยายน 2559 </span><br>
        <a class="btn btn-info btn-xs" href="file/major_HP_3_2557.pdf" role="button"> อ่านต่อ » </a>
      </div>
    </li>
  </ul>
  <ul class="media-list">
    <li class="media">
      <div class="media-left">
        <a href="#">
          <img class="media-object" src="images/fund-02.png" alt="...">
        </a>
      </div>
      <div class="media-body">
        <h4 class="media-heading">ประกาศรับสมัครทุนเรียนดี</h4>
        <a class="btn btn-info btn-xs" href="http://web.sut.ac.th/dsa/sutfund" role="button"> อ่านต่อ » </a>
      </div>
    </li>
  </ul>
</div>
